...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBoxName.setText(_translate("Form", "name"))
        self.checkBoxSeat.setText(_translate("Form", "seat number"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Numbering"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "name"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "license number"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Form", "flight number"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Flight date"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Form", "seat number"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Boarding port"))
        ...
        self.checkBoxPort.setText(_translate("Form", "Boarding port"))
        self.checkBoxLicense.setText(_translate("Form", "license number"))
        self.pushButtonQuery.setText(_translate("Form", "Inquire"))
